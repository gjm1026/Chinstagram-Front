    ...
    <div className="card-align">
      <Card className={classes.root}>
            ...
            <div>
              ...
              >
                <div style={{ marginLeft: 15, marginRight: 15 }}>
                  ...
                  <div style={{ margin: 15 }} onClick={handleClickOpen}>
                    삭제
                  </div>
                </div>
              </Popover>
        ...
        <CardContent>
          ...
          />
          <Button style={{ margin: 10 }} variant="contained" onClick={onInsert}>
            등록
          </Button>
          <ul>
            {commentList.map((value, index) => (
              <li className="card-comment-style" key={index}>
                ...
                <div style={{ marginLeft: 0, marginTop: 5 }}>{value}</div>
              </li>
            ))}
          </ul>
        </CardContent>
